...
namespace TraktSharp.Modules {
	...
	public partial class TraktSyncModule {
		...
		/// <returns>See summary</returns>
		public async Task<TraktRemoveResponse> RemoveFromCollectionByShowIdAsync(string showId, TraktTextShowIdType showIdType = TraktTextShowIdType.Auto) {
		...
		/// <param name="showIdType">The show ID type</param>
		/// <returns>See summary</returns>
		public async Task<TraktRemoveResponse> RemoveFromCollectionByShowIdAsync(int showId, TraktNumericShowIdType showIdType) {
			return await RemoveFromCollectionAsync(TraktShowFactory.FromId(showId, showIdType));
		}
