...
namespace TraktSharp.Modules {
	...
	public class TraktSearchModule : TraktModuleBase {
		...
		/// <summary>
		///     Perform a text query that searches titles, descriptions, translated titles, aliases, and people. Items
		///     searched include movies, shows, episodes, people, and lists. Results are ordered by the most relevant score.
		/// </summary>
		...
		/// <summary>
		///     Lookup an item by using a trakt ID or other external ID. This is helpful to get an items info including the
		///     trakt ID.
		/// </summary>
