...
namespace TraktSharp.Modules {
	...
	public partial class TraktSyncModule {
		...
		/// <summary>
		///     This method is a useful first step in the syncing process. We recommended caching these dates locally, then you can
		///     compare to know exactly what data has
		///     changed recently. This can greatly optimize your syncs so you don't pull down a ton of data only to see nothing has
		///     actually changed.
		/// </summary>
		...
		///     different media centres or apps. For example, you can start
		///     watching a movie in a media center, stop it, then resume on your tablet from the same spot. Each item will have the
