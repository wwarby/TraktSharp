...
namespace TraktSharp.Modules {
	...
	public class TraktRecommendationsModule : TraktModuleBase {
		...
		/// <returns>See summary</returns>
		public async Task DismissMovieRecommendationAsync(TraktMovie movie) { await DismissMovieRecommendationAsync(movie.Ids.GetBestId()); }

		/// <summary>Dismiss a movie to prevent it from being recommended in the future</summary>
		/// <param name="movieId">The movie ID</param>
		/// <returns>See summary</returns>
		public async Task DismissMovieRecommendationAsync(string movieId) { await SendAsync(new TraktRecommendationsShowsDismissRequest(Client) {Id = movieId}); }
		...
		/// <returns>See summary</returns>
		public async Task DismissShowRecommendationAsync(TraktShow show) { await DismissShowRecommendationAsync(show.Ids.GetBestId()); }

		/// <summary>Dismiss a show to prevent it from being recommended in the future</summary>
		/// <param name="showId">The show ID</param>
		/// <returns>See summary</returns>
		public async Task DismissShowRecommendationAsync(string showId) { await SendAsync(new TraktRecommendationsShowsDismissRequest(Client) {Id = showId}); }
