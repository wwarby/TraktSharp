...
namespace TraktSharp.Modules {
	...
	public class TraktShowsModule : TraktModuleBase {
		...
		public async Task<IEnumerable<TraktShow>> GetPopularShowsAsync(TraktExtendedOption extended = TraktExtendedOption.Unspecified, int? page = null, int? limit = null) => await SendAsync(new TraktShowsPopularRequest(Client) {
			Extended = extended,
		...
		/// <param name="limit">The number of records to show per page</param>
		/// <returns>See summary</returns>
		public async Task<IEnumerable<TraktShowsTrendingResponseItem>> GetTrendingShowsAsync(TraktExtendedOption extended = TraktExtendedOption.Unspecified, int? page = null, int? limit = null) => await SendAsync(new TraktShowsTrendingRequest(Client) {
			Extended = extended,
			Pagination = new TraktPaginationOptions(page, limit)
		});
		...
		/// <param name="limit">The number of records to show per page</param>
		/// <returns>See summary</returns>
		public async Task<IEnumerable<TraktShowsUpdatesResponseItem>> GetUpdatedShowsAsync(DateTime? startDate = null, TraktExtendedOption extended = TraktExtendedOption.Unspecified, int? page = null, int? limit = null) => await SendAsync(new TraktShowsUpdatesRequest(Client) {
			StartDate = startDate,
			Extended = extended,
			Pagination = new TraktPaginationOptions(page, limit)
		});
		...
		/// <param name="extended">Changes which properties are populated for standard media objects. By default, minimal data is returned. Change this if additional fields are required in the returned data.</param>
		/// <returns>See summary</returns>
		public async Task<TraktShow> GetShowAsync(string showId, TraktExtendedOption extended = TraktExtendedOption.Unspecified) => await SendAsync(new TraktShowsSummaryRequest(Client) {
			Id = showId,
			Extended = extended
		});
		...
		/// <param name="extended">Changes which properties are populated for standard media objects. By default, minimal data is returned. Change this if additional fields are required in the returned data.</param>
		/// <returns>See summary</returns>
		public async Task<IEnumerable<TraktShowsTranslationsResponseItem>> GetTranslationsAsync(string showId, string language, TraktExtendedOption extended = TraktExtendedOption.Unspecified) => await SendAsync(new TraktShowsTranslationsRequest(Client) {
			Id = showId,
			Language = language,
			Extended = extended
		});
