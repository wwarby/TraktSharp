...
namespace TraktSharp.Helpers {
	...
	public static class EnumsHelper {
		...
		public static T FromDescription<T>(string value) { return (T) (object) GetEnumInfo(typeof (T)).Values.First(e => value.Equals(e.Description, StringComparison.InvariantCultureIgnoreCase)).Value; }
