...
namespace TraktSharp.Helpers {
	...
	public static class TraktEnumHelper {
		...
		/// <returns>
		///     An instance of the specified enumeration type, or throws an exception if <paramref name="value" /> is not a
		///     valid value for the specified enumeration type
		/// </returns>
		public static T FromInt<T>(int value) => (T) Enum.Parse(typeof(T), value.ToString(CultureInfo.InvariantCulture));

		/// <summary>
		///     Parses an integer to a specified enumeration type, allowing silent fallback to a default value of parsing
		///     fails
		/// </summary>
		/// <typeparam name="T">The enumeration type</typeparam>
		/// <param name="value">The enumeration member value</param>
		/// <param name="defaultValue">
		///     The value to be returned if <paramref name="value" /> is not a valid value for the specified
		///     enumeration type
		/// </param>
		...
		/// <returns>
		///     An instance of the specified enumeration type, or throws an exception if <paramref name="value" /> is not a
		///     valid text label for the specified enumeration type
		/// </returns>
		public static T FromLabel<T>(string value) => (T) Enum.Parse(typeof(T), value, true);

		/// <summary>
		///     Parses a text label to a specified enumeration type, allowing silent fallback to a default value of parsing
		///     fails
		/// </summary>
		/// <typeparam name="T">The enumeration type</typeparam>
		/// <param name="value">The text label value</param>
		/// <param name="defaultValue">
		///     The value to be returned if <paramref name="value" /> is not a valid text label for the
		...
		/// <returns>
		///     An instance of the specified enumeration type, or throws an exception if <paramref name="value" /> is not a
		///     valid description for the specified enumeration type
		/// </returns>
		public static T FromDescription<T>(string value) => FromDescription(value, default(T));

		/// <summary>
		///     Parses a description (from <see cref="DescriptionAttribute" />) to a specified enumeration type, allowing
		///     silent fallback to a default value of parsing fails
		/// </summary>
		/// <typeparam name="T">The enumeration type</typeparam>
		/// <param name="value">The description value</param>
		/// <param name="defaultValue">
		///     The value to be returned if <paramref name="value" /> is not a valid description for the
		///     specified enumeration type
		/// </param>
		/// <returns>An instance of the specified enumeration type</returns>
