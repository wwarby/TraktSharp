...
namespace TraktSharp.Enums {
	...
	public class TraktEnumMemberInfo : IEquatable<TraktEnumMemberInfo> {
		...
		public override string ToString() {
			return !string.IsNullOrEmpty(Description) ? Description : string.IsNullOrEmpty(Label) ? Label : Value.ToString(CultureInfo.InvariantCulture);
		}

		/// <summary>Determines whether two object instances are equal</summary>
		/// <param name="obj">The object to compare with the current object</param>
		/// <returns><c>true</c> if the specified object is equal to the current object, otherwise <c>false</c></returns>
		public override bool Equals(object obj) { return (obj is TraktEnumMemberInfo) && Equals((TraktEnumMemberInfo)obj); }
		...
		public bool Equals(TraktEnumMemberInfo obj) { return Value == obj.Value; }
		...
		public static bool operator ==(TraktEnumMemberInfo obj1, TraktEnumMemberInfo obj2) { return obj1 != null && obj1.Equals(obj2); }
