...
namespace TraktSharp.Enums {
	...
	public class TraktEnumMemberInfo : IEquatable<TraktEnumMemberInfo> {
		...
		/// <returns>
		///     <c>true</c> if the specified <see cref="TraktEnumMemberInfo" /> is equal to the current object, otherwise
		///     <c>false</c>
		/// </returns>
		public bool Equals(TraktEnumMemberInfo obj) => Value == obj?.Value;

		/// <summary>
		///     Formats the enumeration member metadata as a string, using the first non-null result from description, label
		///     or value
		/// </summary>
		...
		public override bool Equals(object obj) => obj is TraktEnumMemberInfo member && Equals(member);
		...
		/// <param name="obj2">The second <see cref="TraktEnumMemberInfo" /> instance</param>
		/// <returns>
		///     <c>true</c> if the <see cref="TraktEnumMemberInfo" /> instances are not equal, otherwise <c>false</c>
		/// </returns>
		public static bool operator !=(TraktEnumMemberInfo obj1, TraktEnumMemberInfo obj2) => (obj1 != null) && !obj1.Equals(obj2);
