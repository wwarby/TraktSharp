namespace TraktSharp.Enums {
	...
	public enum TraktAuthenticationMode {
		...
		OAuth,
		/// <summary>
		/// Authentication using simple token headers. This is a special case where the application will is allowed to use a simpler token based authentication instead of OAuth.
