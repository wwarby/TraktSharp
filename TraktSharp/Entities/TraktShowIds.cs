...
namespace TraktSharp.Entities {
	...
	/// <summary>A collection of unique identifiers for a show in various web services</summary>
	[Serializable]
	public class TraktShowIds {
		...
		public bool HasAnyValuesSet() => (Trakt > 0) || !string.IsNullOrEmpty(Slug) || (Tvdb > 0) || !string.IsNullOrEmpty(Imdb) || (Tmdb > 0) || (TvRage > 0);
