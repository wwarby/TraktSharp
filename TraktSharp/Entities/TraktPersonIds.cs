...
namespace TraktSharp.Entities {
	...
	/// <summary>A collection of unique identifiers for a person in various web services</summary>
	[Serializable]
	public class TraktPersonIds {
		...
		/// <summary>The ID for this item from imdb.com. This should always start with <c>nm</c>.</summary>
		...
		public bool HasAnyValuesSet() => Trakt > 0 || !string.IsNullOrEmpty(Slug) || !string.IsNullOrEmpty(Imdb) || Tmdb > 0 || TvRage > 0;
